  ...
  return (
    <Link href="/" className="flex items-center gap-3">
      ...
      <div className="relative w-10 h-10">
        ...
        {/* Foreground Shape */}
        <div className="absolute inset-0 bg-gradient-to-br from-secondary-800 to-secondary-900 rounded-xl flex items-center justify-center">
      ...
      <div className="hidden sm:flex flex-col leading-tight">
        ...
        <span className="text-xs text-slate-500 font-medium">Academy</span>
      </div>
    </Link>
  );
};
